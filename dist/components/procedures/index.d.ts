declare const procedures: {
    nomination: {
        ...
        Proposal: ({ procedure, proposal, accountInOrgans, wrapTransaction, t, publicClient, walletClient }: import('./nomination').NominationProposalProps) => import("react/jsx-runtime").JSX.Element;
    };
    vote: {
